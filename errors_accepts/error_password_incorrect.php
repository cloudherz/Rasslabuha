<?php
    echo "<script>setTimeout('location.replace(`../account.php`)', 15000);</script>";
?>
<!DOCTYPE HTML>
<html>
<head>
...
<section class="page page_account">
    ...
    <main class="main">
        <section class="section" id="section">
            <h1 class="errors">Неверный пароль!</h1>
            <h2 class="errors">Забыл пароль? Пиши - <a href="https://vk.com/sh1ft_yt" class="aerrors" title="Написать Шифту (Нефору)">мне</a></h2>
        </section>
