            ...
            <div class="container">
                <div class="row">
                    <div class="col" style="margin-bottom: 1em;">
                        <h2 style="margin-bottom: 0.7em; margin-top: 0.2em;">Создание карты</h2>
                        <form action="validation-form/check.php" method="post" class="regauth">
                            <input type="number" class="form-control regauth" name="name" id="name" placeholder="Введите 4 любых числа для номера карты">
                            <input type="number" class="form-control regauth" name="pass" id="pass" placeholder="Придумайте защитный код из 3-ёх цифр">
                            <button class="btn_regauth_card_create">Создать карту</button>
                        </form>
                    </div>
                </div>
            </div>
