            ...
            <div class="container">
                <div class="row">
                    <div class="col" style="margin-bottom: 1em;">
                        <h1 class="errors" style="margin-bottom: 0.7em; margin-top: 0.2em;">Выберите банк</h1>
                        <button class="btn_bank_choose" style="margin: 0 0; display: block; margin-bottom: 0; font-family: MonumentumE_Ultrabold"><a style="text-decoration: none; color: white; margin: 0 0" href="ets_card_mayami_create.php">MAYAMI BANK</a></button>
                    </div>
                </div>
            </div>
